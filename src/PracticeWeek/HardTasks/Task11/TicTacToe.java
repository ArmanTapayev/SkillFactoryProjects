package PracticeWeek.HardTasks.Task11;
/*
Задача 11
...
checkGame() — метод должен определить есть ли победитель в игре, если да, то вернуть X/0 в зависимости от того, кто победил, если победителя нет, то метод должен вернуть D (ничья), если игра еще продолжается, то вернуть null;
...
public class TicTacToe {
    ...
    String makeMove(int x, int y) {
        ...
        if (check != null) {
            ...
            else if (check.equals("0")) return "Player 0 win";
            else return "Draw";
        }
