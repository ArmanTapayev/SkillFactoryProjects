package PracticeWeek.HardTasks.Task12;
/*
Задача 12
Давайте напишем программу-помощник для игры в морской бой. Многие люди часто забывают отмечать клетки,
в которые они стреляли, не закрашивают клетки вокруг потопленных кораблей и так далее.
...
# — если стреляли, но не попали (или, например, потопили корабль, а эта клетка соседняя),
