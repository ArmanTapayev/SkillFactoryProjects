...
/*
Задача 13
Все мы знаем, что белочки любят собирать орешки и нести их себе домой (ведь знаем?).
Так вот, одной белочке сначала очень не везло, и она не нашла ни одного орешка, как вдруг, по дороге домой,
она увидела много пеньков, на некоторых лежали орешки. Но некоторые пеньки были кривыми,
если белочка прыгнет на такой пенек, то точно потеряет несколько орешков.

Ваша задача — написать программу, которая будет считать, какое максимальное количество орешков белочка
сможет донести до домика, если пропрыгает по всем этим пенькам.

Белочка — не супермен, поэтому прыгать она может либо на каждый пенек, либо через один.
Также не обязательно начинать с первого пенька, можно сразу прыгнуть на второй, то же самое касается и последних двух.
